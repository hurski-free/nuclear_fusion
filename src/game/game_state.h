...
struct GameState {
  ...
  static constexpr double kDustEpsBonusPer = 0.01;
  static constexpr double kDustClickBonusPer = 0.02;
  ...
  static std::vector<UpgradeDef> CreateDefaultUpgrades() {
    ...
    list.push_back(UpgradeDef{
        ...
        0});
    // Coil bonuses: H..Au progression (strong late-game isotope EPS mult).
    list.push_back(UpgradeDef{
    ...
    list.push_back(UpgradeDef{
        ...
        L"+0.02 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Helium", 3},
         {ResourceKind::Energy, "", 5000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 0.02, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+0.25 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Oxygen", 3},
         {ResourceKind::Energy, "", 20000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 0.25, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+1 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Silicon", 3},
         {ResourceKind::Energy, "", 40000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 1.0, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+10 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Iron", 3},
         {ResourceKind::Energy, "", 80000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 10.0, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+25 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Nickel", 3},
         {ResourceKind::Energy, "", 100000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 25.0, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+500 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Silver", 3},
         {ResourceKind::Energy, "", 140000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 500.0, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+4000 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Xenon", 3},
         {ResourceKind::Energy, "", 170000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 4000.0, 0});
    ...
    list.push_back(UpgradeDef{
        ...
        L"+400000 isotope EPS multiplier",
        {{ResourceKind::Isotope, "Gold", 3},
         {ResourceKind::Energy, "", 200000}},
        1.6, UpgradeEffect::IsotopeEpsMult, 400000.0, 0});
  ...
  // Heavier isotopes generate more passive energy (0.01 eV/s per Z).
  double IsotopeEpsPer(const Element& el) const {
    return 0.01 * static_cast<double>(el.atomic_number);
  }
  ...
  double Eps() const {
    const double dust_mult = 1.0 + star_dust * kDustEpsBonusPer;
    // Flat dust EPS (passive dust + Dust Dynamo) is outside the dust EPS mult.
    return (auto_eps + IsotopeEps()) * dust_mult + star_dust + dust_flat_eps;
  }
